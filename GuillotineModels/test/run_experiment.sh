...
easy_for_furini=`echo ./instance/okp{1,4,5} ./instance/CU1 ./instance/STS4{,s} ./instances/gcut9`
...
julia run_model.jl --do-not-solve --faithful2furini2016 --no-redundant-cut "$tl" $instances 2>&1 | tee experiment_1_`date -Iminutes`.log
...
for i in 1 2 3 4 5; do
	...
	julia run_model.jl --faithful2furini2016 --round2disc --seed "$i" --time-limit "$tl" $easy_instances 2>&1 | tee experiment_6_${i}_`date -Iminutes`.log
